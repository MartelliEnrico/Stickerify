...
public final class ImageHelper {
	...
	private static final List<String> SUPPORTED_FORMATS = List.of("jpeg", "png");
	...
	private static BufferedImage resizeImage(BufferedImage originalImage) {
		LOGGER.debug("The original file has size {}x{}", originalImage.getWidth(), originalImage.getHeight());
